...
export const tools = [
    ...
    },
    {
        ...
        keywords: ["json", "format", "prettier", "beautify", "validator", "beautifier", "prettify", "prettifier", "json formatter", "json validator", "json beautifier", "json prettifier", "format json", "json syntax", "json editor"]
    },
    {
